(function () {
...
})()(
  {
    ...
    2: [
      function (t, e, r) {
        "use strict";
        const { get: n, set: o, del: s } = t("idb-keyval");
        const a = async (t) => {
          try {
        ...
        const i = (t, e, r) => {
          ...
          try {
            o(`loader_${t}`, JSON.stringify({ data: e, expiry: Date.now() + (Number.isNaN(n) ? 60 * 60 * 1e3 * 24 : n) }));
          } catch (t) {
            return;
          }
        };
        const u = (t, e) => {
          ...
          for (let e = 0; e < o.attributes.length; e++) {
            const { name: r, value: n } = o.attributes[e];
        ...
        const p = () => {
            ...
            const e = t.some((t) =>
              Array.from(t.addedNodes).some(
                (t) =>
                  ...
                  ((t.getAttribute("data-src") && !t.getAttribute("data-rendered")) || t.querySelector("svg[data-src]:not([data-rendered])"))
              )
            );
            if (e) {
              b();
          ...
          t.observe(document.documentElement, { attributeFilter: ["data-src"], attributes: true, childList: true, subtree: true });
        };
        const w = setInterval(() => {
          b();
        }, 100);
